...
public class Requerimiento {
	...
	private List<RequerimientoBien> listaDetalle;
	...
	public List<RequerimientoBien> getListaDetalle() {
		return listaDetalle;
	}

	public void setListaDetalle(List<RequerimientoBien> listaDetalle) {
